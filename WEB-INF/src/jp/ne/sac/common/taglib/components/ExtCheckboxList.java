...
/**
 * 拡張CheckboxListコンポーネントクラス.
 * <p>
 * CheckboxListを拡張したCheckboxListコンポーネントクラス。<br>
 *
 * @author m_hamaoka
 * @version 1.0
 * @since 2014/07/14
 */
public class ExtCheckboxList extends CheckboxList {
     ...
     */
    public ExtCheckboxList(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
